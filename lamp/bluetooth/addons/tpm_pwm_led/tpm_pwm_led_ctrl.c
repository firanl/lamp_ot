...
//TODO - check if static is required for tpm_general_config_t and tpm_pwm_param_t data ?
...
void TPM_PWM_Init(void)
{
  ...
  const tpm_general_config_t driverInfo_0 = {      //TPM 0 configuration structure 
        .isDBGMode = FALSE,
  ...
  const tpm_general_config_t driverInfo_1 = {      //TPM 1 configuration structure
        .isDBGMode = FALSE,
        .isGlobalTimeBase = FALSE,
        .isTriggerMode = FALSE,
        .isStopCountOnOveflow = FALSE,
...
void TPM_PWM_WarmWhite(uint8_t dutyCycleWarmWhite)
{
  tpm_pwm_param_t paramWW = {
            ...
            .uDutyCyclePercent = dutyCycleWarmWhite // 0 to 100
  };
...
void TPM_PWM_ColdWhite(uint8_t dutyCycleColdWhite)
{
  tpm_pwm_param_t paramCW = {
            ...
            .edgeMode          = kTpmHighTrue,
            .uFrequencyHZ      = BOARD_TPM_FRQ_HZ,
            .uDutyCyclePercent = dutyCycleColdWhite // 0 to 100
  };
...
void TPM_PWM_Red(uint8_t dutyCycleColorRed)
{
  tpm_pwm_param_t paramR = {
          ...
          .edgeMode          = kTpmHighTrue,
          .uFrequencyHZ      = BOARD_TPM_FRQ_HZ,
          .uDutyCyclePercent = dutyCycleColorRed // 0 to 100
  };
...
void TPM_PWM_Green(uint8_t dutyCycleColorGreen)
{
   tpm_pwm_param_t paramG = {
            ...
            .edgeMode          = kTpmHighTrue,
            .uFrequencyHZ      = BOARD_TPM_FRQ_HZ,
            .uDutyCyclePercent = dutyCycleColorGreen // 0 to 100
  };
...
void TPM_PWM_Blue(uint8_t dutyCycleColorBlue)
{
   tpm_pwm_param_t paramB = {
            ...
            .edgeMode          = kTpmHighTrue,
            .uFrequencyHZ      = BOARD_TPM_FRQ_HZ,
            .uDutyCyclePercent = dutyCycleColorBlue // 0 to 100
  };  
