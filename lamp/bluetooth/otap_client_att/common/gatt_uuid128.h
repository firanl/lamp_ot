...
/* BLE Lamp - White and RGB lamp control */
UUID128(uuid_service_lamp,           0xE0, 0x1C, 0x4B, 0x5E, 0x1E, 0xEB, 0xA1, 0x5C, 0xEE, 0xF4, 0x5E, 0xBA, 0x53, 0x55, 0xFF, 0x01) 
    /* Characteristics */
    UUID128(uuid_char_lamp_Control,  0xE0, 0x1C, 0x4B, 0x5E, 0x1E, 0xEB, 0xA1, 0x5C, 0xEE, 0xF4, 0x5E, 0xBA, 0x54, 0x55, 0xFF, 0x01) 
    UUID128(uuid_char_lamp_White,    0xE0, 0x1C, 0x4B, 0x5E, 0x1E, 0xEB, 0xA1, 0x5C, 0xEE, 0xF4, 0x5E, 0xBA, 0x56, 0x55, 0xFF, 0x01) 
    UUID128(uuid_char_lamp_RGB,      0xE0, 0x1C, 0x4B, 0x5E, 0x1E, 0xEB, 0xA1, 0x5C, 0xEE, 0xF4, 0x5E, 0xBA, 0x59, 0x55, 0xFF, 0x01)
    UUID128(uuid_char_core_voltage,  0xE0, 0x1C, 0x4B, 0x5E, 0x1E, 0xEB, 0xA1, 0x5C, 0xEE, 0xF4, 0x5E, 0xBA, 0x60, 0x55, 0xFF, 0x01)
    UUID128(uuid_char_lamp_on_sec,   0xE0, 0x1C, 0x4B, 0x5E, 0x1E, 0xEB, 0xA1, 0x5C, 0xEE, 0xF4, 0x5E, 0xBA, 0x61, 0x55, 0xFF, 0x01)
    UUID128(uuid_char_lamp_off_sec,  0xE0, 0x1C, 0x4B, 0x5E, 0x1E, 0xEB, 0xA1, 0x5C, 0xEE, 0xF4, 0x5E, 0xBA, 0x62, 0x55, 0xFF, 0x01)
    UUID128(uuid_char_lamp_config,      0xE0, 0x1C, 0x4B, 0x5E, 0x1E, 0xEB, 0xA1, 0x5C, 0xEE, 0xF4, 0x5E, 0xBA, 0x63, 0x55, 0xFF, 0x01)